...
public class MyClass
{
    ...
    public static float SuiPian_DownForce = -5f;
    //碎片生成时间
    public static float SuiPian_CreatRate = 2f;


    //收集碎片数量
    public static float Socre;

    public static float Player_PreDownForce= -10f;//玩家初始下落速度
    public static float Player_DownForce;//玩家当前下落速度

    //接触碎片后减少下降的速度
    public static float LowForce = 1f;
